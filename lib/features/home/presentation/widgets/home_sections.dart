...
class SectionCategories extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final cats = [
      _Cat('sedan',    l.catSedan,    Icons.directions_car,       const VehicleFilter(bodyType: 'sedan')),
      _Cat('suv',      l.catSuv,      Icons.directions_car_filled, const VehicleFilter(bodyType: 'suv')),
      _Cat('pickup',   l.catPickup,   Icons.local_shipping,        const VehicleFilter(bodyType: 'pickup')),
      _Cat('van',      l.catVan,      Icons.airport_shuttle,       const VehicleFilter(bodyType: 'van')),
      _Cat('hatchback',l.catHatchback,Icons.directions_car_outlined,const VehicleFilter(bodyType: 'hatchback')),
      _Cat('electric', l.catElectric, Icons.bolt,                  const VehicleFilter(fuel: 'hybrid')),
    ];
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Row(children: [
            Expanded(child: Text(l.categoriesTitle,
...
class _CatCell extends ConsumerStatefulWidget {
  const _CatCell({required this.cat, required this.isLast,
    required this.ref, required this.onTap});
  final _Cat cat;
  final bool isLast;
  final WidgetRef ref;
                ...
                child: Column(
                  ...
                  children: [
                    _CategorySvgIcon(
                      name: widget.cat.key,
                      size: 32,
                      color: _hovered ? AppColors.primary : const Color(0xFF0F172A),
                    ),
                    const SizedBox(height: 6),
                    Text(widget.cat.label, textAlign: TextAlign.center,
                      style: TextStyle(
...
final _catCountProvider = FutureProvider.family<int, VehicleFilter>((ref, filter) async {
  try {
            ...
            data: (list) => GridView.builder(
              ...
              itemBuilder: (context, i) {
                ...
                return GestureDetector(
                  onTap: () => context.go('/vehicules', extra: VehicleFilter(brandId: brand.id)),
                  child: Container(
                    decoration: BoxDecoration(
                      color: AppColors.surface,
                      border: Border.all(color: AppColors.border),
...
final _lifestyleProvider = FutureProvider.family<_LifeData, VehicleFilter>((ref, filter) async {
  try {
    final repo = ref.read(vehicleRepositoryProvider);
    final result = await repo.list(
      page: 1, perPage: 5,
...
class _BrandLogo extends StatefulWidget {
  ...
  static const _domains = {
    'toyota': 'toyota.com', 'hyundai': 'hyundai.com', 'kia': 'kia.com',
    'nissan': 'nissan.com', 'honda': 'honda.com', 'ford': 'ford.com',
    'renault': 'renault.com', 'peugeot': 'peugeot.com', 'bmw': 'bmw.com',
    'mercedes-benz': 'mercedes-benz.com', 'audi': 'audi.com',
    'volkswagen': 'volkswagen.com', 'mitsubishi': 'mitsubishi.com',
    'suzuki': 'suzuki.com', 'mazda': 'mazda.com', 'fiat': 'fiat.com',
    'citroen': 'citroen.com', 'dacia': 'dacia.com', 'isuzu': 'isuzu.com',
    'land-rover': 'landrover.com', 'lexus': 'lexus.com',
    'opel': 'opel.com', 'geely': 'geely.com', 'byd': 'byd.com',
    'chery': 'chery.com',
  };
