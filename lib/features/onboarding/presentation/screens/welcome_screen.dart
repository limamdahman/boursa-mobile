                  ...
                  Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: CustomPaint(
                        ...
                        child: const Center(
                          child: Icon(Icons.directions_car_outlined, size: 72, color: Color(0x4016A34A)),
                        ),
                      ),
                    ),
                  ),
                  ...
                  children: [
                    Text(
                      ...
                      style: GoogleFonts.sourceSans3(
                        ...
                        height: 1.25, color: Colors.white, letterSpacing: -0.4,
                      ),
                    ),
                      ...
                      child: Material(
                        ...
                        child: InkWell(
                          ...
                          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                            Text('Commencer',
                                style: GoogleFonts.sourceSans3(fontSize: 17, fontWeight: FontWeight.w700, color: Colors.white)),
                    ...
                    Center(
                      child: Text('Gratuit  •  Sans engagement',
                          style: GoogleFonts.sourceSans3(fontSize: 13, color: Colors.white.withOpacity(0.45))),
                    ),
                  ],
                ),
              ),
...
class _DarkStripePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()..color = const Color(0x1516A34A)..strokeWidth = 12;
